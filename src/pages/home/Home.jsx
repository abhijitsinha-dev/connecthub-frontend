        ...
        <div className="w-full max-w-7xl flex flex-col lg:flex-row lg:justify-end gap-8">
          <section className="w-full lg:max-w-3xl">
            ...
            <div className="space-y-5">
              ...
              {loading && (
                <div className="space-y-5">
                  {[...Array(posts.length > 0 ? 1 : 3)].map((_, i) => (
                    <div
                      key={i}
                      className="bg-bg-primary rounded-2xl shadow-sm border border-border-primary p-5 animate-pulse"
                    >
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="h-48 w-full bg-bg-secondary rounded-xl mt-4" />
                      </div>
                    </div>
                  ))}
                </div>
